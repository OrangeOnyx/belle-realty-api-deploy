...
let ParkingController = class ParkingController {
    ...
    findAll(query) { return this.parkingService.findAll(query); }
    findOne(id) { return this.parkingService.findOne(id); }
    create(body) { return this.parkingService.create(body); }
    update(id, body) { return this.parkingService.update(id, body); }
    remove(id) { return this.parkingService.remove(id); }
};
exports.ParkingController = ParkingController;
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List parking' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get parking by id' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create parking' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update parking' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete parking' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
