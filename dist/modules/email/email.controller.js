...
let EmailController = class EmailController {
    ...
    findAll(query) { return this.emailService.findAll(query); }
    findOne(id) { return this.emailService.findOne(id); }
    create(body) { return this.emailService.create(body); }
    update(id, body) { return this.emailService.update(id, body); }
    remove(id) { return this.emailService.remove(id); }
};
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete email' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
