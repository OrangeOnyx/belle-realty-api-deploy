...
let MaintenanceController = class MaintenanceController {
    ...
    findAll(query) { return this.maintenanceService.findAll(query); }
    findOne(id) { return this.maintenanceService.findOne(id); }
    create(body) { return this.maintenanceService.create(body); }
    update(id, body) { return this.maintenanceService.update(id, body); }
    remove(id) { return this.maintenanceService.remove(id); }
};
exports.MaintenanceController = MaintenanceController;
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List maintenance' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create maintenance' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete maintenance' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
